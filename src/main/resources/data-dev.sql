...
insert into question(topic_id, question) values (1, 'Some Question');
insert into answer(question_id, answer, display, correct) values (1, 'a', 'ABC', false);
insert into answer(question_id, answer, display, correct) values (1, 'b', 'FNB', true);
